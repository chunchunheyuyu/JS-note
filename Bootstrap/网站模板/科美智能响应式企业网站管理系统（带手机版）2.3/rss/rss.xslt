...
<xsl:stylesheet
     ...
     <html>
		...
		<div class="ChannelTitle">
		     <a href="{link}" target="_blank"><xsl:value-of select="title" /></a><span>  <xsl:value-of select="description" /></span>
		</div>
     ...
     <xsl:template match="item">
          <div class="ArticleEntry">
               ...
               <div class="ArticleHeader">
                    <xsl:value-of select="pubDate" />  |  <xsl:value-of select="author" />  |  <xsl:value-of select="category" />
               </div>
