<%
dim cn,strConn,juhaoyongDatabasePath,juhaoyongDatabaseName
juhaoyongDatabasePath="../Systemdata/"'末尾必须带斜杠“/”
juhaoyongDatabaseName="systemdata.mdb"
Set cn=Server.CreateObject("ADODB.Connection")
strConn="Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" & Server.MapPath(juhaoyongDatabasePath&juhaoyongDatabaseName)'数据库路径
cn.open strConn
%>
