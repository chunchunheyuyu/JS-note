...
If act="save" Then 
	...
	response.Write JuhaoyongResultPage("轮播图片添加","添加成功","index_lunbo_list.asp")
	response.end
else
%>
	...
	<tr>
	  <th class="tableHeaderText">轮播图片添加</th>
	</tr>
	<tr>
	...
	<tr>
	<td class="jhyabTabletdBgcolor01" width="15%" height=23>标题 (必填) </td>
	<td class="jhyabTabletdBgcolor01"><input name='name' type='text' id='name' size='70'>
	  ...
	  <tr>
	    ...
	    <td class="jhyabTabletdBgcolor01"><input name='url' type='text' id='url' size='70'>填写“站内链接”或者“站外链接”均可</td>
      </tr>
