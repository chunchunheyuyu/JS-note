...
<!-- #include file="inc/head.asp" -->
	...
	<tr>
	  <th class="tableHeaderText">推荐到首页</th>
	</tr>
...
response.Write "<a href='abjhy_product_list.asp?oneid="&oneid&"&twoid="&twoid&"&page="&page&"&act="&act&"&keywords="&keywords&"'><font size='+1'>返 回</font></a>"
%>
            </td>
          </tr>
        </table>
