...
function showInnerText(Id){
	...
	switch(switchId){
	    case 1:
		   ...
		   break;
	    case 2:
		   showText =  "进入系统后，首先在这里对网站进行配置，包含网站名称、网址、首页轮播、在线客服、友情链接等信息。";
		   break;
	    case 3:
		   showText =  "管理前台导航，添加、删除、修改导航，设置导航和栏目的对应关系，或者设置导航的外部链接，完成操作后请重新生成所有静态。";
		   break;		   
	    case 4:
		   showText =  "管理栏目、内容、订单、留言，如新闻、产品等内容。";
		   break;	
	    case 5:
	    ...
	    case 8:
		   ...
		   break;		   
	    case 9:
		   showText =  "在这里添加栏目下的文章，如新闻、产品等内容。";		   		}
...
<div id="nav">
    <ul>
    <li id="man_nav_1" onclick="list_sub_nav(id,'后台首页')"  class="bg_image_onclick">后台首页</li>
